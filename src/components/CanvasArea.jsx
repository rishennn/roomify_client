...
export default function CanvasArea({
  ...
  return (
    <main className="flex-1 bg-[#080c14] flex flex-col overflow-hidden relative w-full h-full select-none">
      <div className="w-full bg-[#0b111e]/90 border-b border-slate-800/60 px-4 sm:px-6 py-3 flex items-center justify-between shrink-0 min-h-[56px] z-10">
        {activeItem ? (
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-0 items-start sm:items-center justify-between w-full">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
              ...
              >
                <RotateCw className="w-3.5 h-3.5 shrink-0" /> <span>Rotate</span>
              </button>
              <button
